    ...
    div []
        [ div [ class "hands group" ]
            [ div [ class "purple-background w-100 h-100 " ]
                [ div [ class "white b f2 f1-l tc pl3 pr3 pt5 tracked w-50-l m0-auto" ]
                    [ text "We are here to help." ]
                , div [ class "white-line pb4" ] []
                , div [ class "tc-l" ]
                    [ div [ class "pt5-l w-50-l tc-l dib-l " ] [ whiteButton "SEE REAL STORIES" "quotes" ]
                    ]
                , div [ class "tc-l" ]
                    [ div [ class "pt1-l w-50-l tc-l dib-l  " ] [ whiteButton "SEE OUR SERVICES" "services" ]
                    ]
                , div [ class "tc-l" ]
