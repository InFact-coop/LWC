...
quoteMaker : String -> String -> String -> Quote
...
quotesList =
    ...
    , quoteMaker "2" "./assets/woman2.png" "I didn't know which way to turn after a recent separation. With LWC's help i now feels much more supported and know that help is always on hand for form filling , advice and money matters"
